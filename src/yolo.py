...
from src import loadweights, nmsupress, process, setting, utili

# define the model
model = loadweights.make_yolov3_model()
# load the model weights
weight_reader = loadweights.WeightReader(r'F:\OneDrive\nuig\modules\mechanics of search\assignment_2\Object-Detection---Yolov3\model\yolov3.weights')
# set the model weights into the model
weight_reader.load_weights(model)
# # save the model to file
model.save(r'F:\OneDrive\nuig\modules\mechanics of search\assignment_2\Object-Detection---Yolov3\model\model.h5')
